...
#ifndef GTLxLib_LIBRARY_DEFINED
#define GTLxLib_LIBRARY_DEFINED

//! IID of LIBID_GTLxLib
EXTERN_C const IID LIBID_GTLxLib;

#ifndef IGTLEvents_DISPINTERFACE_DEFINED
#define IGTLEvents_DISPINTERFACE_DEFINED

//! IID of DIID__IGTLEvents
EXTERN_C const IID DIID__IGTLEvents;

#if defined(__cplusplus) && !defined(CINTERFACE)

//! RPC MIDL Interface for GTL Events
...
//! Direct ABI interface for GTL Events
...
#endif // IGTLEvents_DISPINTERFACE_DEFINED

#ifndef IGTL_INTERFACE_DEFINED
#define IGTL_INTERFACE_DEFINED
