...
public:
  /**
         ...
         */
  static void read_pak_contents(const std::string& path, PakContents& contents);

  /**
         * Writes Pak Contents to file.
         * @param path     Path to assets file.
         */
  static void write_pak_contents(const std::string& path, PakContents& contents);
  ...
  /**
         ...
         * @return todo
         */
  static bool read_info_contents(const std::string& path, InfoContents& contents);
  ...
  /**
         ...
         * @return todo
         */
  static bool write_info_contents(const std::string& path, InfoContents& contents);
  ...
  /**
         ...
         * @return todo
         */
  static bool export_pak_asset(const std::string& parent_dir, const std::shared_ptr<PakAsset>& asset);
  ...
  /**
         ...
         * @return todo
         */
  static bool export_dat_asset(const std::string& parent_dir, const std::shared_ptr<PakAsset>& asset);
};
}// namespace assets
