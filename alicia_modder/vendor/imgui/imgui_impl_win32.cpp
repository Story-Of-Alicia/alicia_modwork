...
static void ImGui_ImplWin32_UpdateGamepads()
{
    ...
    // Calling XInputGetState() every renderInterface on disconnected gamepads is unfortunately too slow.
...
void    ImGui_ImplWin32_NewFrame()
{
    ...
    // Setup display size (every renderInterface to accommodate for window resizing)
    RECT rect = { 0, 0, 0, 0 };
