...
//  2021-02-18: DirectX9: Change blending equation to preserve alpha in output stack_buffer.
//  2019-05-29: DirectX9: Added support for large mesh (64K+ vertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag.
//  2019-04-30: DirectX9: Added support for special ImDrawCallback_ResetRenderState callback to reset renderInterface state.
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // Setup renderInterface state: fixed-pipeline, alpha-blending, no face culling, no depth testing, shade mode (for gradient)
...
void ImGui_ImplDX9_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // Copy and convert all vertices into a single contiguous stack_buffer, convert colors to DX9 default format.
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            if (pcmd->UserCallback != NULL)
            {
                ...
                // (ImDrawCallback_ResetRenderState is a special callback value used by the user to request the renderer to reset renderInterface state.)
